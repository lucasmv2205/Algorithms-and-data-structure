...
// Lista das opera��es: inicializa_lista, lista_vazia, lista_cheia, insere_elemento, remove_elemento, obtem_valor_elemento, libera_lista, imprime_lista
typedef struct no *Lista;

// Entradas: nenhuma
// Pre-condicao: nenhuma
// Processo: criar uma Lista sem valores definidos e aloca espaco na memoria
// Saida: endere�o de uma Lista criada
